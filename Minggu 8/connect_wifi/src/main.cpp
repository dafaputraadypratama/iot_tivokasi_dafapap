...
const char* ssid = "Sing butuh ae";
const char* password = "tukangbakso";
...
void loop() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    HTTPClient http;
    String url = "http://81dd-175-45-191-15.ngrok-free.app/api/posts"; // Ganti dengan URL ngrok yang benar
